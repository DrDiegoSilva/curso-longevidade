titulo: MOTS-c — muito comentado, quase toda a evidência ainda é pré-clínica
eixo: Metabolismo

## corpo
É um dos peptídeos mais comentados na prática hoje, apesar de ser o caso mais "pré-clínico puro" do levantamento inteiro desta trilha — vale entender exatamente o que já existe e o que ainda é expectativa.
...
Dados pré-clínicos recentes (2025) sugerem papéis protetores em senescência de células beta pancreáticas e em resistência à insulina relacionada à idade — é a base mecanística que explica o interesse, mesmo sem confirmação clínica ainda.

### Protocolo

Não existe protocolo humano validado — o que está em teste (CB4211, MOTS-c investigacional) roda dentro de programas de pesquisa fechados, sem dose de referência pública validada por resultado publicado.
...
## aviso
Sem registro ANVISA — classificado como experimental/não aprovado no Brasil. Praticamente toda a evidência disponível hoje é pré-clínica; o único ensaio de fase 2a ativo ainda não tem resultado publicado.
